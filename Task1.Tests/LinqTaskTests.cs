...
namespace Task1.Tests
{
    ...
    public class Tests
    {
        ...
        //This test case has mistake, there are 4 customers, that exceed given values. Was checked manually
        ...
        public void Linq9_Customers_ReturnsGroupedProducts()
        {
            ...
            foreach (var valueTuple in result)
            {
                ...
                Assert.That(valueTuple.averageIncome, Is.EqualTo(expectedValue.averageIncome));
                Assert.That(valueTuple.averageIntensity, Is.EqualTo(expectedValue.averageIntensity));
            }
        }
